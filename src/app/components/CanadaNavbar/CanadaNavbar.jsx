...
const CANADA_NAV_LINKS = [
  { id: "home", label: "Home", href: "/canada" },
      ...
      <div className="max-w-7xl mx-auto px-3 sm:px-6 lg:px-8">
        <div className="flex justify-between items-center h-[72px]">
          <div className="flex-shrink-0 flex items-center -ml-2 sm:-ml-4 lg:-ml-6">
            <Link href="/canada" className="flex items-center group">
              <img
              ...
              if (link.hasDropdown) {
                return (
                  ...
                  >
                    ...
                    {isOpen && (
                      <div
                        className="absolute left-0 mt-2 w-[380px] origin-top-left rounded-[20px] bg-white border border-gray-100 p-4 shadow-[0_12px_45px_rgba(0,0,0,0.08)] z-50 animate-canada-nav-dropdown"
                        onMouseEnter={() => handleMouseEnter(link.id)}
                        onMouseLeave={() => handleMouseLeave(link.id)}
                      >
