...
function SoftwareLogoBadge({ name }) {
  ...
  return (
    ...
    >
      {/* Logo Image */}
      <div
        className={`w-full h-full flex items-center justify-center transition-all duration-300 ${clicked ? "opacity-0 scale-75" : "opacity-100 scale-100 group-hover:opacity-0 group-hover:scale-75"
          }`}
      >
        <img
          src={logoSrc}
      ...
      {/* Name on hover/click */}
      <div
        className={`absolute inset-0 flex items-center justify-center p-2 bg-white text-center transition-all duration-300 ${clicked
...
export default function UKServicesContent({ serviceSlug }) {
  const showA = !serviceSlug || serviceSlug === "management-accounts-financial-reporting";
  const showB = !serviceSlug || serviceSlug === "payroll-cis-services";
  const showC = !serviceSlug || serviceSlug === "personal-tax-services";
  const showD = !serviceSlug || serviceSlug === "uk-bookkeeping-service";
  const showE = !serviceSlug || serviceSlug === "uk-business-advisory-virtual-cfo-services";
  const showF = !serviceSlug || serviceSlug === "uk-company-formation-company-secretarial-services";
  const showG = !serviceSlug || serviceSlug === "vat-service-making-tax-digital-mtd";
  const showH = !serviceSlug || serviceSlug === "year-end-accounts-corporation-tax";
          ...
          <div className="w-full bg-[#FEF4E4] py-[5px] lg:py-16 px-4 sm:px-6 lg:px-8 border-b border-[#FF6A00]/10">
            <div className="max-w-7xl mx-auto grid grid-cols-1 lg:grid-cols-2 gap-[10px] lg:gap-16 items-stretch">
              ...
              <div className="relative h-[220px] sm:h-[300px] lg:h-auto w-full rounded-[18px] overflow-hidden shadow-md group">
                <Image
                  src="/images/DSC09781.JPG"
                  alt="Reliable Payroll & CIS Support"
                  fill
                  className="object-cover transition-transform duration-700 group-hover:scale-[1.02]"
                  sizes="(max-width: 1024px) 100vw, 50vw"
                />
        ...
        <>
          ...
          <div className="w-full bg-white py-[5px] lg:py-16 px-4 sm:px-6 lg:px-8 border-b border-gray-100">
            <div className="max-w-7xl mx-auto grid grid-cols-1 lg:grid-cols-2 gap-[10px] lg:gap-16 items-stretch">
              ...
              <div className="relative h-[220px] sm:h-[300px] lg:h-auto w-full rounded-[18px] overflow-hidden shadow-md order-2 lg:order-1 group">
                <Image
            ...
            <div className="max-w-7xl mx-auto grid grid-cols-1 lg:grid-cols-2 gap-[10px] lg:gap-16 items-stretch">
              ...
              <div className="relative h-[220px] sm:h-[300px] lg:h-auto w-full rounded-[18px] overflow-hidden shadow-md group">
                <Image
                  ...
                  alt="Reliable Bookkeeping Support"
                  fill
                  className="object-cover transition-transform duration-700 group-hover:scale-[1.02]"
                  sizes="(max-width: 1024px) 100vw, 50vw"
                />
        ...
        <>
          ...
          <div className="w-full bg-[#FEF4E4] py-[5px] lg:py-16 px-4 sm:px-6 lg:px-8 border-b border-[#FF6A00]/10">
            <div className="max-w-7xl mx-auto grid grid-cols-1 lg:grid-cols-2 gap-[10px] lg:gap-16 items-stretch">
              ...
              <div className="relative h-[220px] sm:h-[300px] lg:h-auto w-full rounded-[18px] overflow-hidden shadow-md group">
                <Image
                  src="/images/bgimagetwo.JPG"
                  alt="Business Advisory & CFO Services"
                  fill
                  className="object-cover transition-transform duration-700 group-hover:scale-[1.02]"
                  sizes="(max-width: 1024px) 100vw, 50vw"
                />
          ...
          <div className="w-full bg-[#FEF4E4] py-[5px] lg:py-16 px-4 sm:px-6 lg:px-8 border-b border-[#FF6A00]/10">
            <div className="max-w-7xl mx-auto grid grid-cols-1 lg:grid-cols-2 gap-[10px] lg:gap-16 items-stretch">
              ...
              <div className="relative h-[220px] sm:h-[300px] lg:h-auto w-full rounded-[18px] overflow-hidden shadow-md group">
                <Image
                  src="/images/Akash Param.png"
                  alt="Company Secretarial Support"
                  fill
                  className="object-cover transition-transform duration-700 group-hover:scale-[1.02]"
                  sizes="(max-width: 1024px) 100vw, 50vw"
                />
          ...
          <div className="w-full bg-[#FEF4E4] py-[5px] lg:py-16 px-4 sm:px-6 lg:px-8 border-b border-[#FF6A00]/10">
            <div className="max-w-7xl mx-auto grid grid-cols-1 lg:grid-cols-2 gap-[10px] lg:gap-16 items-stretch">
              ...
              <div className="relative h-[220px] sm:h-[300px] lg:h-auto w-full rounded-[18px] overflow-hidden shadow-md group">
                <Image
                  src="/images/bgimage.JPG"
                  alt="Specialist VAT Compliance Support"
                  fill
                  className="object-cover transition-transform duration-700 group-hover:scale-[1.02]"
                  sizes="(max-width: 1024px) 100vw, 50vw"
                />
            ...
            <div className="max-w-7xl mx-auto">
              ...
              <div className="grid grid-cols-1 md:grid-cols-3 gap-5">
                ...
                <div className="bg-white rounded-2xl p-5 border border-gray-100 shadow-xs">
                  ...
                  <div className="grid grid-cols-2 lg:grid-cols-3 gap-2.5">
                    {["IRIS Accounts Production", "CCH Accounts Production", "Capium", "Xero & QuickBooks Online", "Sage Business Cloud", "FreeAgent"].map((sw, idx) => (
                      <SoftwareLogoBadge key={idx} name={sw} />
                    ))}
                  </div>
                </div>
                ...
                <div className="bg-white rounded-2xl p-5 border border-gray-100 shadow-xs">
                  ...
                  <div className="grid grid-cols-2 lg:grid-cols-3 gap-2.5">
                    {["IRIS Business Tax", "CCH Corporation Tax", "BTCSoftware Tax", "Capium Corporation Tax"].map((sw, idx) => (
                      <SoftwareLogoBadge key={idx} name={sw} />
                    ))}
                  </div>
                </div>
