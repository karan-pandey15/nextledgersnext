...
import ServiceHomePage from "@/app/components/ServiceMainPageContent/ServiceHomePage";
...
/**
 * UK-pattern regional home page — same layout as /uk and /singapore.
 */
export default function RegionalCountryHome({
  homePath,
  servicesLabel,
  serviceLinks,
  flagCode,
      ...
      >
        <div className="relative mx-auto w-full max-w-6xl">
          <div className="mb-8 text-center sm:mb-10">
            ...
            >
              {serviceLinks.length} Specialist Service Lines
            </span>
            <h2
          ...
          <nav aria-label={servicesAriaLabel || `${regionName} services`}>
