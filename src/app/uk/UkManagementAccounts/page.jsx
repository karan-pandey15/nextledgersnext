                ...
                <div className="mx-auto max-w-6xl px-4 sm:px-6 lg:px-8">
                    <div className="grid grid-cols-1 items-stretch gap-8 lg:grid-cols-2 lg:gap-10 xl:gap-12">
                        ...
                        <div className="flex flex-col">
                            ...
                            <div
                                className="relative mt-5 overflow-hidden rounded-xl px-5 py-5 text-center sm:mt-6 sm:px-6 sm:py-6"
                            ...
                            >
                                ...
                                />
                                <p
                                    className="relative mx-auto max-w-md text-[13px] leading-[1.65] sm:text-[14px]"
                                    style={{ color: "#4B5563" }}
                                >
                                    Having access to this information allows business owners to make
                                    proactive decisions rather than reacting to problems after
                                    year-end.
                                </p>
                            </div>
                        </div>
