...
export default function UkBookkeeping() {
    ...
    return (
        <main className="relative min-h-screen w-full overflow-x-hidden bg-white">
                ...
                <div className="relative mx-auto flex w-full max-w-5xl flex-col justify-center">
                    <div className="flex flex-col items-center px-2 text-center">
                        ...
                        <h1 className="max-w-[300px] text-2xl font-extrabold leading-snug text-[#0B1F3A] sm:max-w-2xl sm:text-3xl lg:text-[34px]">
                            UK Bookkeeping &amp;{" "}
                            <span className="text-[#FF6A00]">VAT Outsourcing</span>{" "}
                            Services
                        </h1>
            ...
            <BookKeepingMatters splitHero className="!py-3" />
            ...
            <WhyChooseSplitSection
                ...
                titleMiddle=" for "
                titleAccent2="Bookkeeping & VAT"
                titleAfter="?"
                subtitle="Dedicated bookkeeping specialists who work as an extension of your practice, ensuring total accuracy and HMRC compliance."
