    ...
    return (
        <main className="relative min-h-screen w-full overflow-x-hidden bg-white">
                ...
                <div className="relative mx-auto flex w-full max-w-5xl flex-col justify-center">
                    <div className="flex flex-col items-center px-2 text-center">
                        ...
                        <h1 className="max-w-[320px] text-2xl font-extrabold leading-snug text-[#0B1F3A] sm:max-w-3xl sm:text-3xl lg:text-[34px]">
                            ...
                            <span className="text-[#FF6A00]">Virtual CFO</span> Outsourcing
                            Services
                        </h1>
            ...
            <section className="relative w-full overflow-hidden bg-white py-3">
                <div className="mx-auto max-w-[1440px] px-4 sm:px-6 lg:px-10">
                    ...
                    >
                        ...
                        <IndustriesWeSupportGrid industries={UK_BUSINESS_ADVISORY_INDUSTRIES} />
                    </div>
                </div>
            </section>
            ...
            <WhyChooseSplitSection
                ...
                titleMiddle=" for Business Advisory"
                titleAfter="?"
                subtitle="Dedicated advisory specialists who work as an extension of your practice, delivering strategic insight with accuracy and care."
                items={whyChooseCards}
                imageSrc="/images/DSC09669.JPG"
                imageAlt="NextLedgers business advisory specialists"
            />
