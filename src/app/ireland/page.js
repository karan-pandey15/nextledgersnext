...
import { IRELAND_TRUST_BADGES } from "../components/ServiceMainPageContent/TrustBadgesBar";
      ...
      >
        <div className="relative mx-auto w-full max-w-6xl">
          <div className="mb-8 text-center sm:mb-10">
            ...
            >
              {IRELAND_SERVICE_LINKS.length} Specialist Service Lines
            </span>
            <h2
