...
import { IRELAND_INDUSTRIES } from "@/app/ireland/irelandPageContent";
...
const PARTNER_TRUST = [
  { icon: ShieldCheck, label: "100% Revenue-Aligned Processes" },
  { icon: Lock, label: "Secure & Confidential" },
  { icon: Users, label: "Trusted by Irish Accounting Firms" },
];
...
function normalizeMatterBullet(item, index) {
  if (typeof item === "string") {
    ...
    return {
      title,
      description: `Supports Irish practices that need to ${lower.replace(/\.$/, "")}.`,
  ...
  return {
    ...
    description:
      item.description ||
      `Supports Irish practices focused on ${String(item.title || "")
        .charAt(0)
...
/**
 * Shared Ireland Service page — UI aligned to UK Year-End / VAT master template.
 */
export default function IrelandServiceTemplate({ data }) {
  const [isSidebarOpen, setIsSidebarOpen] = useState(false);
  const badges = data.trustBadges || IRELAND_TRUST_BADGES;
  const stats = data.stats || [
    {
      icon: <Users className="h-5 w-5" />,
      value: "500+",
      label: "IE Firms Supported",
    },
    {
    ...
    },
    {
      ...
      value: "100%",
      label: "Revenue Compliant Processes",
    },
    {
    ...
    <main className="relative min-h-screen w-full overflow-x-hidden bg-white">
          ...
          <div className="mb-7 flex flex-col items-center text-center sm:mb-8">
            ...
            >
              ...
              <span style={{ color: ORANGE }}>
                {data.deliverablesAccent || "Ireland Service"}
              </span>{" "}
              Services
            </h2>
          ...
          <div className="relative mx-auto flex w-full max-w-6xl flex-col">
            <div className="mb-7 flex flex-col items-center text-center sm:mb-8">
              ...
              >
                How We Help{" "}
                <span style={{ color: ORANGE }}>
                  {data.howWeHelpAccent || "Irish Accounting Firms"}
                </span>
              </h2>
              ...
              >
                {data.howWeHelpIntro ||
                  "Our offshore support enables Irish practices to:"}
              </p>
            </div>
      ...
      <IconDisplayScreen
        ...
        subtitle={
          ...
          "We work across the accounting, tax, payroll, and document platforms Irish firms already use."
        }
              ...
              <div className="mx-auto max-w-[720px] text-center">
                ...
                >
                  {data.industriesBlurb ||
                    "We support Irish accounting firms and accountancy practices serving clients across a wide range of sectors, including:"}
                </p>
              </div>

              <IndustriesWeSupportGrid
                industries={data.industries || IRELAND_INDUSTRIES}
              />
            </div>
          </div>
        </section>
      ...
      <WhyChooseSplitSection
        ...
        subtitle={
          ...
          "Dedicated Ireland accounting specialists who work as an extension of your practice."
        }
        ...
        imageAlt="NextLedgers Ireland accounting specialists"
      />
