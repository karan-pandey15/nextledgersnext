    ...
    <main className="flex min-h-screen flex-col overflow-x-hidden bg-white font-sans text-[#1E1B2A]">
      ...
      <section className="relative overflow-hidden px-4 pb-10 pt-10 sm:px-6 sm:pb-12 sm:pt-12 lg:px-8 lg:pb-14 lg:pt-14">
        <div
          ...
          style={{
            background: `radial-gradient(ellipse 80% 60% at 50% -10%, rgba(255, 106, 0,0.16), transparent 55%), linear-gradient(180deg, ${PAGE_CREAM} 0%, #ffffff 100%)`,
          }}
        />
        <div
        ...
        <div className="relative mx-auto max-w-5xl text-center">
          <span className="mb-4 inline-flex items-center gap-2 rounded-full border border-[#FF6A00]/25 bg-white px-3.5 py-1.5 text-[10px] font-bold uppercase tracking-[0.14em] text-[#FF6A00] shadow-sm sm:text-[11px]">
          ...
          <div className="mx-auto mt-7 flex max-w-xl flex-col items-stretch gap-3 sm:flex-row sm:items-center sm:justify-center">
            <div className="relative flex-1">
              ...
              <input
                ...
                className="h-12 w-full rounded-[12px] border border-slate-200 bg-white pl-10 pr-4 text-[14px] text-[#0B1F3A] shadow-sm outline-none transition focus:border-[#FF6A00] focus:ring-2 focus:ring-[#FF6A00]/20"
              />
            </div>
            <Link
              href="/contact"
              className="inline-flex h-12 items-center justify-center gap-2 rounded-[12px] px-5 text-[13px] font-bold uppercase tracking-wide text-white shadow-md transition hover:bg-[#E85E00]"
              ...
              return (
                <button
                  ...
                  className={`inline-flex shrink-0 items-center gap-1.5 rounded-full border px-3.5 py-2 text-[12px] font-bold transition sm:text-[13px] ${
                    isActive
                      ? "border-[#FF6A00] bg-[#FF6A00] text-white shadow-md shadow-orange-500/25"
                      : "border-slate-200 bg-white text-slate-700 hover:border-[#FF6A00]/40 hover:text-[#FF6A00]"
                  }`}
                >
            ...
            <div className="grid grid-cols-2 gap-3 sm:grid-cols-3 sm:gap-4 md:grid-cols-4 lg:grid-cols-5 xl:grid-cols-6">
              {filteredTools.map((tool) => (
                <article
                  ...
                  className="group flex flex-col items-center rounded-2xl border border-[#F0E0D2] bg-white p-4 shadow-[0_6px_20px_rgba(15,39,74,0.04)] transition duration-200 hover:-translate-y-1 hover:border-[#FF6A00]/35 hover:shadow-[0_14px_34px_rgba(255, 106, 0,0.12)] sm:p-5"
                >
                  ...
                  <span className="mt-2 rounded-full bg-[#FFF4EA] px-2.5 py-0.5 text-[10px] font-semibold uppercase tracking-wide text-[#FF6A00]">
                    {tool.categoryLabel}
                  </span>
                </article>
              ))}
      ...
      <section className="relative overflow-hidden px-4 py-12 sm:px-6 sm:py-14 lg:px-8">
        <div className="relative mx-auto max-w-4xl overflow-hidden rounded-[22px] bg-[#07111F] px-6 py-12 text-center sm:px-10 sm:py-14">
          <div
            ...
            style={{
              backgroundImage:
                "radial-gradient(rgba(255, 106, 0,0.35) 1px, transparent 1px)",
          ...
          <div className="relative z-10">
            ...
            <div className="mt-7 flex flex-col items-center justify-center gap-3 sm:flex-row sm:gap-4">
              <Link
                href="/contact"
                className="inline-flex h-11 min-w-[200px] items-center justify-center gap-2 rounded-[10px] px-6 text-[13px] font-bold uppercase tracking-wide text-white shadow-md transition hover:bg-[#E85E00]"
                style={{ background: ORANGE }}
              >
                Contact Us
                <ArrowRight className="h-4 w-4" />
              ...
              <a
                ...
                className="cta-fill-orange-dark inline-flex h-11 min-w-[200px] items-center justify-center gap-2 rounded-[10px] px-6 text-[13px] font-bold uppercase tracking-wide"
              >
