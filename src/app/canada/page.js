                ...
                return (
                  <li key={service.href} className="min-w-0">
                    ...
                    >
                      ...
                      <span
                        className="mt-1 flex h-8 w-8 shrink-0 items-center justify-center rounded-full border border-[#F0E6DC] text-[14px] text-[#FF6A00] transition-all duration-200 group-hover:border-[#FF6A00] group-hover:bg-[#FFF4EA] sm:h-9 sm:w-9"
                        aria-hidden="true"
                      >
                        →
                      </span>
