...
export default function CanadaServiceTemplate({ data }) {
  ...
  const stats = data.stats || [
    { logo: 4, value: "500+", label: "Canadian Firms Supported" },
    { logo: 15, value: "30+", label: "Software Integrations" },
    { logo: 18, value: "100%", label: "CRA Compliant Processes" },
    { logo: 16, value: "Dedicated", label: "Support Team" },
  ];
