...
import { UAE_INDUSTRIES } from "@/app/uae/uaePageContent";
...
const PARTNER_TRUST = [
  { icon: ShieldCheck, label: "100% FTA-Aligned Processes" },
  { icon: Lock, label: "Secure & Confidential" },
  { icon: Users, label: "Trusted by UAE Accounting Firms" },
];
...
function normalizeMatterBullet(item, index) {
  if (typeof item === "string") {
    ...
    return {
      title,
      description: `Supports UAE practices that need to ${lower.replace(/\.$/, "")}.`,
  ...
  return {
    ...
    description:
      item.description ||
      `Supports UAE practices focused on ${String(item.title || "")
        .charAt(0)
...
/**
 * Shared UAE Service page — UI aligned to UK Year-End / VAT master template.
 */
export default function UAEServiceTemplate({ data }) {
  const [isSidebarOpen, setIsSidebarOpen] = useState(false);
  const badges = data.trustBadges || UAE_TRUST_BADGES;
    ...
    <main className="relative min-h-screen w-full overflow-x-hidden bg-white">
          ...
          <div className="mb-7 flex flex-col items-center text-center sm:mb-8">
            ...
            >
              ...
              <span style={{ color: ORANGE }}>
                {data.deliverablesAccent || "UAE Service"}
              </span>{" "}
              Services
            </h2>
          ...
          <div className="relative mx-auto flex w-full max-w-6xl flex-col">
            <div className="mb-7 flex flex-col items-center text-center sm:mb-8">
              ...
              >
                How We Help{" "}
                <span style={{ color: ORANGE }}>
                  {data.howWeHelpAccent || "UAE Accounting Firms"}
                </span>
              </h2>
      ...
      <IconDisplayScreen
        ...
        subtitle={
          ...
          "We work across the accounting, tax, payroll, and document platforms UAE firms already use."
        }
              ...
              <div className="mx-auto max-w-[720px] text-center">
                ...
                >
                  {data.industriesBlurb ||
                    "We support UAE Accounting Firms and accountancy practices serving clients across a wide range of sectors, including:"}
                </p>
              </div>

              <IndustriesWeSupportGrid
                industries={data.industries || UAE_INDUSTRIES}
              />
            </div>
          </div>
        </section>
      ...
      <WhyChooseSplitSection
        ...
        subtitle={
          ...
          "Dedicated UAE Accounting specialists who work as an extension of your practice."
        }
        ...
        imageAlt="NextLedgers UAE Accounting specialists"
      />
