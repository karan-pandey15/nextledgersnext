...
import { NEW_ZEALAND_INDUSTRIES } from "@/app/new-zealand/nzPageContent";
...
const PARTNER_TRUST = [
  { icon: ShieldCheck, label: "100% IRD-Aligned Processes" },
  { icon: Lock, label: "Secure & Confidential" },
  { icon: Users, label: "Trusted by New Zealand Accounting Firms" },
];
...
function normalizeMatterBullet(item, index) {
  if (typeof item === "string") {
    ...
    return {
      title,
      description: `Supports New Zealand practices that need to ${lower.replace(/\.$/, "")}.`,
  ...
  return {
    ...
    description:
      item.description ||
      `Supports New Zealand practices focused on ${String(item.title || "")
        .charAt(0)
...
/**
 * Shared New Zealand Service page — UI aligned to UK Year-End / VAT master template.
 */
export default function NZServiceTemplate({ data }) {
  const [isSidebarOpen, setIsSidebarOpen] = useState(false);
  const badges = data.trustBadges || NEW_ZEALAND_TRUST_BADGES;
  const stats = data.stats || [
    {
      icon: <Users className="h-5 w-5" />,
      value: "500+",
      label: "NZ Firms Supported",
    },
    {
  ...
  return (
    <main className="relative min-h-screen w-full overflow-x-hidden bg-white">
          ...
          <div className="mb-7 flex flex-col items-center text-center sm:mb-8">
            ...
            >
              ...
              <span style={{ color: ORANGE }}>
                {data.deliverablesAccent || "New Zealand Service"}
              </span>{" "}
              Services
            </h2>
          ...
          <div className="relative mx-auto flex w-full max-w-6xl flex-col">
            <div className="mb-7 flex flex-col items-center text-center sm:mb-8">
              ...
              >
                How We Help{" "}
                <span style={{ color: ORANGE }}>
                  {data.howWeHelpAccent || "New Zealand Accounting Firms"}
                </span>
              </h2>
              ...
              >
                {data.howWeHelpIntro ||
                  "Our offshore support enables New Zealand practices to:"}
              </p>
            </div>
      ...
      <IconDisplayScreen
        ...
        subtitle={
          data.softwareSubtitle ||
          "We work across the accounting, tax, payroll, and document platforms New Zealand firms already use."
        }
              ...
              <div className="mx-auto max-w-[720px] text-center">
                <div className="inline-flex items-center justify-center gap-3">
                  ...
                  <p
                    ...
                    style={{ color: ORANGE }}
                  >
                    {data.industriesEyebrow || "Our Industry Expertise"}
                  </p>
                  <span
                    className="hidden h-px w-8 sm:block"
                    style={{ background: ORANGE }}
                ...
                <h2
                  ...
                  style={{ color: NAVY }}
                >
                  {data.industriesTitleBefore || "Industries We "}
                  <span style={{ color: ORANGE }}>
                    {data.industriesTitleAccent || "Support"}
                  </span>
                </h2>
                ...
                <p
                  ...
                  style={{ color: GREY }}
                >
                  {data.industriesBlurb ||
                    "We support New Zealand Accounting Firms and accountancy practices serving clients across a wide range of sectors, including:"}
                </p>
              </div>

              <IndustriesWeSupportGrid
                industries={data.industries || NEW_ZEALAND_INDUSTRIES}
              />
            </div>
          </div>
        </section>
      ...
      <WhyChooseSplitSection
        ...
        subtitle={
          ...
          "Dedicated New Zealand accounting specialists who work as an extension of your practice."
        }
        ...
        imageAlt="NextLedgers New Zealand accounting specialists"
      />
