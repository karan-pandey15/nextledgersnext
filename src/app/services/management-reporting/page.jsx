...
const trustBadges = [
    { icon: ShieldCheck, label: "Actionable", sub: "Business Insights" },
...
const serviceLines = [
    ...
    {
        title: "Budget, Variance & Trends",
        shortTitle: "Budget & Trends",
        icon: Activity,
        items: [
...
const visibilityBenefits = [
    {
        ...
        description:
            "Use reliable financial information to support stronger planning and forecasting.",
    },
    {
        icon: Scale,
        title: "Stronger Financial Control",
        description:
            "Monitor results consistently so leadership can manage risk and performance.",
    },
    {
        icon: Workflow,
        title: "Improved Operations",
        description:
            "Convert complex data into reports that improve day-to-day operational decisions.",
    },
    {
        icon: Lightbulb,
        title: "Identify Opportunities",
        description:
            "Highlight growth opportunities and improvement areas with clear analysis.",
    },
    {
        icon: Eye,
        title: "Monitor Profitability",
        description:
            "Track margins, costs, and performance drivers with easy-to-understand reports.",
    },
    {
        icon: TrendingUp,
        title: "Confident Decisions",
        description:
            "Give owners and leadership teams the clarity needed to act with confidence.",
    },
];

const visibilityTrustItems = [
    { icon: ShieldCheck, label: "Timely Reports" },
...
const partnerTrust = [
    { icon: ShieldCheck, label: "Meaningful Management Reports" },
    { icon: Lock, label: "Secure & Confidential" },
    ...
    return (
        <main className="relative min-h-screen w-full overflow-x-hidden bg-white">
                ...
                <div className="relative mx-auto flex w-full max-w-5xl flex-col justify-center">
                    <div className="flex flex-col items-center px-2 text-center">
                        ...
                        <h1 className="max-w-[320px] text-2xl font-extrabold leading-snug text-[#0B1F3A] sm:max-w-3xl sm:text-3xl lg:text-[34px]">
                            Meaningful{" "}
                            <span className="text-[#FF6A00]">Management Reporting</span>{" "}
                        ...
                        <p className="mt-2 max-w-xs text-[12.5px] leading-snug text-slate-600 sm:max-w-2xl sm:text-[13px] md:text-sm">
                            Timely, accurate, and insightful reports that explain
                            performance, track KPIs, and highlight improvement
                            opportunities.
                            <br className="hidden sm:block" />
                            Built for startups, SMEs, enterprises, and accounting firms.
                        </p>
                    ...
                    <div className="grid grid-cols-1 items-center gap-10 lg:grid-cols-2 lg:gap-12">
                        <div>
                            ...
                            <h2 className="mb-3 text-[28px] font-extrabold leading-[1.15] text-[#0B1F3A] sm:text-[30px]">
                                Comprehensive Management Reporting Services
                            </h2>
                            ...
                            <p className="mb-3 text-[13px] leading-relaxed text-gray-500 sm:text-[15px]">
                                Making informed business decisions requires more than
                                standard financial statements. Business owners and
                                management teams need timely, accurate, and insightful
                                reports that clearly explain financial performance,
                                identify trends, monitor key metrics, and highlight
                                opportunities for improvement.
                            </p>

                            <p className="mb-3 text-[13px] leading-relaxed text-gray-500 sm:text-[15px]">
                                At NextLedgers, we transform financial data into clear,
                                actionable business insights. Our reporting solutions
                                help businesses monitor performance, strengthen financial
                                control, improve profitability, and support confident
                                decision-making.
                            </p>
                            ...
                            <p className="mb-5 text-[13px] leading-relaxed text-gray-500 sm:text-[15px]">
                                ...
                                deliver customised management reports that provide
                                complete visibility into your business performance while
                                supporting strategic planning and long-term growth.
                            </p>
                        ...
                        <div className="relative pb-10 sm:pb-12">
                            <div className="overflow-hidden rounded-2xl">
                                <Image
                                    ...
                                    alt="Management reporting and finance team"
                                    width={720}
                                    height={480}
            ...
            <ServiceDeliverablesExplorer
                ...
                titleBefore="Our "
                titleAccent="Management Reporting"
                titleAfter=" Services Include"
                subtitle="Customised management reports that provide complete visibility into business performance."
            ...
            <BookKeepingMatters
                ...
                titleBefore="Helping Businesses Gain "
                titleAccent="Better Financial"
                titleAfter=" Visibility"
                intro="Our Management Reporting Services provide business owners and leadership teams with reliable financial information that supports better planning, stronger financial control, and improved operational performance."
                helpLabelBefore="We convert complex data into "
                helpLabelAccent="easy-to-understand reports"
                helpLabelAfter=":"
                trustItems={visibilityTrustItems}
                trustFooterBefore="Built for Leadership Teams. "
                trustFooterAccent="Trusted by Growing Businesses."
                benefits={visibilityBenefits}
                bannerTitleBefore="Improve transparency. "
                bannerTitleAccent="Strengthen accountability."
                bannerBody="By combining experienced finance professionals with modern reporting tools and accounting technology, we help businesses establish consistent reporting processes that improve long-term performance."
            />

                        {/* 5 — Why Choose */}
            <WhyChooseSplitSection
                subtitle="Accurate reporting, clear performance insights, and customised management packs that improve financial visibility."
...
{/* 6 — Industries */}
                    ...
                    >
                        <div className="mx-auto max-w-[720px] text-center">
                            ...
                            <p
                                ...
                                style={{ color: GREY }}
                            >
                                We provide Management Reporting Services to businesses
            ...
            <IconDisplayScreen
                ...
                subtitle="Our finance professionals work with leading accounting and reporting platforms."
                ...
                >
                    ...
                    <div className="relative z-10">
                        ...
                        <p
                            ...
                            style={{ color: GREY }}
                        >
                            At NextLedgers, we help businesses move beyond basic
                            financial reporting by delivering meaningful management
                            reports that support smarter decision-making and sustainable
                            growth.
                        </p>
                        ...
                        <div className="mx-auto mt-6 flex max-w-3xl items-start gap-4 rounded-2xl bg-white px-4 py-4 text-left shadow-[0_6px_24px_rgba(15,23,42,0.06)] sm:gap-5 sm:px-6 sm:py-5">
                            ...
                            <p
                                ...
                                style={{ color: GREY }}
                            >
                                Whether you need monthly management accounts, executive
                                dashboards, KPI reporting, or customised financial
                                analysis, our experienced team works as an extension of
                                your business — providing the financial insights and
                                reporting expertise needed to improve performance and
                                achieve your goals.
                            </p>
                        </div>
