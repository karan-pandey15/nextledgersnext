                ...
                <div className="relative mx-auto w-full max-w-6xl">
                    <div className="mb-7 flex flex-col items-center text-center sm:mb-8">
                        ...
                        <p
                            ...
                            style={{ color: GREY }}
                        >
                            Businesses partner with NextLedgers because we combine
                            experienced accounting professionals with efficient
                            offshore delivery and technology-driven workflows.
                        </p>
