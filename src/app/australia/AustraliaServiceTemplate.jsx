...
import { AUSTRALIA_INDUSTRIES } from "@/app/australia/australiaPageContent";
...
const PARTNER_TRUST = [
  { icon: ShieldCheck, label: "100% ATO-Aligned Processes" },
  { icon: Lock, label: "Secure & Confidential" },
  { icon: Users, label: "Trusted by Australian Accounting Firms" },
];
...
function normalizeMatterBullet(item, index) {
  if (typeof item === "string") {
    ...
    return {
      title,
      description: `Supports Australian practices that need to ${lower.replace(/\.$/, "")}.`,
  ...
  return {
    ...
    description:
      item.description ||
      `Supports Australian practices focused on ${String(item.title || "")
        .charAt(0)
...
/**
 * Shared Australia Service page — UI aligned to UK Year-End / VAT master template.
 */
export default function AustraliaServiceTemplate({ data }) {
  const [isSidebarOpen, setIsSidebarOpen] = useState(false);
  const badges = data.trustBadges || AUSTRALIA_TRUST_BADGES;
  const stats = data.stats || [
    {
      icon: <Users className="h-5 w-5" />,
      value: "500+",
      label: "AU Firms Supported",
    },
    {
    ...
    <main className="relative min-h-screen w-full overflow-x-hidden bg-white">
          ...
          <div className="mb-7 flex flex-col items-center text-center sm:mb-8">
            ...
            >
              ...
              <span style={{ color: ORANGE }}>
                {data.deliverablesAccent || "Australia Service"}
              </span>{" "}
              Services
            </h2>
          ...
          <div className="relative mx-auto flex w-full max-w-6xl flex-col">
            <div className="mb-7 flex flex-col items-center text-center sm:mb-8">
              ...
              >
                How We Help{" "}
                <span style={{ color: ORANGE }}>
                  {data.howWeHelpAccent || "Australian Accounting Firms"}
                </span>
              </h2>
              ...
              >
                {data.howWeHelpIntro ||
                  "Our offshore support enables Australian practices to:"}
              </p>
            </div>
      ...
      <IconDisplayScreen
        ...
        subtitle={
          ...
          "We work across the accounting, tax, payroll, and document platforms Australian firms already use."
        }
              ...
              <div className="mx-auto max-w-[720px] text-center">
                ...
                >
                  {data.industriesBlurb ||
                    "We support Australian Accounting Firms and accountancy practices serving clients across a wide range of sectors, including:"}
                </p>
              </div>

              <IndustriesWeSupportGrid
                industries={data.industries || AUSTRALIA_INDUSTRIES}
              />
            </div>
          </div>
        </section>
      ...
      <WhyChooseSplitSection
        ...
        subtitle={
          ...
          "Dedicated Australia accounting specialists who work as an extension of your practice."
        }
        ...
        imageAlt="NextLedgers Australia accounting specialists"
      />
