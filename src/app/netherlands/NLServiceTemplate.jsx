...
import { NETHERLANDS_INDUSTRIES } from "@/app/netherlands/netherlandsPageContent";
...
const PARTNER_TRUST = [
  { icon: ShieldCheck, label: "100% Belastingdienst-Aligned Processes" },
...
function normalizeMatterBullet(item, index) {
  if (typeof item === "string") {
    ...
    return {
      title,
      description: `Supports Dutch practices that need to ${lower.replace(/\.$/, "")}.`,
  ...
  return {
    ...
    description:
      item.description ||
      `Supports Dutch practices focused on ${String(item.title || "")
        .charAt(0)
...
/**
 * Shared Netherlands Service page — UI aligned to UK Year-End / VAT master template.
 */
export default function NLServiceTemplate({ data }) {
    ...
    <main className="relative min-h-screen w-full overflow-x-hidden bg-white">
          ...
          <div className="mb-7 flex flex-col items-center text-center sm:mb-8">
            ...
            >
              ...
              <span style={{ color: ORANGE }}>
                {data.deliverablesAccent || "Netherlands Service"}
              </span>{" "}
              Services
            </h2>
          ...
          <div className="relative mx-auto flex w-full max-w-6xl flex-col">
            <div className="mb-7 flex flex-col items-center text-center sm:mb-8">
              ...
              >
                How We Help{" "}
                <span style={{ color: ORANGE }}>
                  {data.howWeHelpAccent || "Dutch Accounting Firms"}
                </span>
              </h2>
              ...
              >
                {data.howWeHelpIntro ||
                  "Our offshore support enables Dutch practices to:"}
              </p>
            </div>
      ...
      <IconDisplayScreen
        ...
        subtitle={
          ...
          "We work across the accounting, tax, payroll, and document platforms Dutch firms already use."
        }
              ...
              <div className="mx-auto max-w-[720px] text-center">
                ...
                >
                  {data.industriesBlurb ||
                    "We support Dutch Accounting Firms and administratiekantoren serving clients across a wide range of sectors, including:"}
                </p>
              </div>

              <IndustriesWeSupportGrid
                industries={data.industries || NETHERLANDS_INDUSTRIES}
              />
            </div>
          </div>
        </section>
      ...
      <WhyChooseSplitSection
        ...
        subtitle={
          ...
          "Dedicated Netherlands accounting specialists who work as an extension of your practice."
        }
        ...
        imageAlt="NextLedgers Netherlands accounting specialists"
      />
